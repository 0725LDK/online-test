				...
				<div class="authentication-inner">
					...
					<div class="card">
						<div class="card-body">
							...
							<form action="${pageContext.request.contextPath}/loginStudent" method="post" class="mb-3" >
								<div class="mb-3">
									<label for="email" class="form-label">ID</label>
									<input
										class="form-control"
										placeholder="Enter your ID"
										id="studentId" type="text" name="studentId" value="s1"
									/>
								</div>
								<div class="mb-3 form-password-toggle">
									...
									<div class="input-group input-group-merge">
										<input
											class="form-control"
											id="studentPw" type="password" name="studentPw"
											placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;"
											value="1234"
										/>
									</div>
		...
		<div class="container-xxl">
			<div class="authentication-wrapper authentication-basic container-p-y">
				<div class="authentication-inner">
					...
					<div class="card">
						<div class="card-body">
							<h4 class="mb-2">	${loginStudent.studentName} 님 반갑습니다.</h4><br>
							<div>
